// src/assets/components/GooeyNav/GooeyNav.tsx
...
const GooeyNav: React.FC<GooeyNavProps> = ({
  ...
  .effect.filter::after {
    ...
    position: absolute;
    inset: 0;
    background: rgba(255, 255, 255, 0.1); /* transparan, bukan putih solid */
    border: 1px solid rgba(255,255,255,0.4); /* outline */
  ...
  li.active {
    color: white; /* tetap putih saat aktif */
...
`}
      ...
      <div className="relative bg-transparent" ref={containerRef}>
        ...
        <span className="effect filter pointer-events-none" ref={filterRef} />
